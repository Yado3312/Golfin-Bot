...
const dictionaryWord = {
  ...
  startSession: ['creo mi cuenta','inicio sesión', 'inicio de sesión', 'log in', 'registrarse', 'me registro', 'registrarme', 'iniciar sesión', 'logueo', 'login', 'inicio una sesión', 'loguear'],
  ...
  invite: ['como añadir amigos','cómo añadir amigos','agrego amigos','agregar amigos','invitar a mis amigos', 'solicitud amistad', 'jugar con amigos', 'jugar amigos', 'invitar', 'solicitud', 'invito a amigos'],
